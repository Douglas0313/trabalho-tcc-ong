...
<?php
require_once 'Pagina usuario/config-banco-apoia.php';
...
<button name="btnvoltar"  onclick="location.href='index.php'" class="w3-button w3-teal w3-cell w3-round-large w3-right w3-margin-right">
<i class=""></i> Voltar
</button>
